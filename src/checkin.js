...
import { Icon,Container,Button,Content,Root, Header, Left, Body, Right, Title,ListItem, Subtitle } from 'native-base';
...
export default class checkin extends Component {
  ...
  //       ToastAndroid.showWithGravity(
	...
	_fetchStudent = () => {
	   return fetch("http://"+this.state.anotherip+":80/top-siv/api/Attendance.php",{
        method: 'POST',
        headers: {
        ...
        if(responseJsonFromServer.message == 1){
			...
			ToastAndroid.showWithGravity(
			  'YOU ARE ALREADY CHECKED IN FOR TODAY. DO NOT TRY AGAIN',
			  ToastAndroid.LONG,
			  ToastAndroid.CENTER,
			);
        ...
        return(
			...
			<Header style={styles.header}>
			  ...
			  <Body>
				...
				<Subtitle style={styles.subtitle}>Check In ( {this.state.location} )</Subtitle>
			  </Body>
			  <Right />
			</Header>
			<Content padder>
				...
				<View style={{flex:1,justifyContent:"center",alignItems:"center"}}>
						...
						<View header style={styles.layer}>
						  ...
						  <Text style={styles.modaltext}>Studentship: {this.state.studentData.std_type} Student</Text>
